...
#define tim0_16us() TCCR0B &= ~((1<<CS02) | (1<<CS01)); TCCR0B|= (1<<CS00);
#define tim0_128us() TCCR0B &= ~((1<<CS02) | (1<<CS01)); TCCR0B|= (1<<CS01);
#define tim0_1ms() TCCR0B &= ~(1<<CS02); TCCR0B |= (1<<CS01) | (1<<CS00);
#define tim0_4ms() TCCR0B |= (1<<CS02); TCCR0B &= ~((1<<CS01) | (1<<CS00));
#define tim0_16ms() TCCR0B |= (1<<CS02) | (1<<CS00); TCCR0B &= ~(1<<CS01) ;


#define tim0_ovf_enable() TIMSK0 |= (1<<TOIE0);
#define tim0_ovf_disable() TIMSK0 |= (0<<TOIE0);
